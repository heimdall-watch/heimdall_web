...
class ImportAllType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        foreach (['role', 'username', 'firstname', 'lastname', 'email', 'class', 'university', 'ufr', 'formation'] as $userField) {
            $builder
                ->add($userField, IntegerType::class, [
                    'required' => true,
                    'attr' => $headerPosAttr,
