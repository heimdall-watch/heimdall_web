 ...
 */
final class Version20200410102806 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE student_presence (id INT NOT NULL, lesson_id INT NOT NULL, student_id INT NOT NULL, present BOOLEAN NOT NULL, late INT DEFAULT NULL, excuse VARCHAR(255) DEFAULT NULL, excuse_proof VARCHAR(255) DEFAULT NULL, excuse_validated BOOLEAN DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE student (id INT NOT NULL, class_group_id INT DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_B723AF334A9A1217 ON student (class_group_id)');
        $this->addSql('CREATE TABLE lesson (id INT NOT NULL, class_group_id INT DEFAULT NULL, teacher_id INT DEFAULT NULL, date_start TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_end TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE class_group (id INT NOT NULL, name VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
