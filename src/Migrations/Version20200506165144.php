 ...
 */
final class Version20200506165144 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE student_presence (id INT NOT NULL, lesson_id INT NOT NULL, student_id INT NOT NULL, present BOOLEAN NOT NULL, late TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, photo_file VARCHAR(255) DEFAULT NULL, excuse_description VARCHAR(255) DEFAULT NULL, excuse_proof VARCHAR(255) DEFAULT NULL, excuse_validated BOOLEAN DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE student (id INT NOT NULL, class_group_id INT DEFAULT NULL, photo_description VARCHAR(255) DEFAULT NULL, photo_file VARCHAR(255) DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
